...
#****************************************************************************
def srwl_und_predef():
    #Undulator params in the order:
                    #       _period, _length, _By_peak, _Bx_peak, _phy, _phx, _sy, _sx
    allUndulators = [
        ['NSLS-II EPU49 LH', [0.049,      4,      0.94,        0, 180,     0,    1,  -1]],   # need to be corrected
        ['NSLS-II EPU49 LV', [0.049,      4,         0,     0.94,   0,   180,    1,  -1]],   # need to be corrected
        ['NSLS-II EPU49 LT', [0.049,      4,      0.94,     0.94,   90?,   0?,   1?, -1?]],   # need to be corrected
        ['NSLS-II EPU49 LC', [0.049,      4,      .................................... ]],   # need to be corrected

        ['NSLS-II EPU57 LV', [0.057,      .............................................1]],   # need to be corrected

        ['NSLS-II U20',      [ 0.02,       3,     1.03,        0,    0,    0,  -1,   1]],
        ['NSLS-II U21',      [0.021,     1.5,     0.91,        0,    0,    0,  -1,   1]],
        ['NSLS-II U22',      [0.022,       6,     0.74,        0,    0,    0,  -1,   1]],
    ]
    return allUndulators
